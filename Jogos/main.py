...
win = pygame.image.load('assentz/win.png')

score1 = 0
score1_img = pygame.image.load('assentz/score/0.png')
score2 = 0
score2_img = pygame.image.load('assentz/score/0.png')
...
def move_ball():
    ...
    if ball_x < -50:
        ...
        ball_dir *= -1
        score2 += 1
        score2_img = pygame.image.load('assentz/score/' + str(score2) + '.png')
        ...
        ball_dir *= -1
        score1 += 1
        score1_img = pygame.image.load('assentz/score/' + str(score1) + '.png')
